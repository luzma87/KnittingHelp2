...
public class StarterPatterns {
    ...
    public static Pattern tmntPattern() {
        ...
        return new Pattern(1L, tmntPatternName, tmntPatternContent);
    }

    public static Pattern splinterPattern() {
        ...
        return new Pattern(2L, splinterPatternName, splinterPatternContent);
    }
